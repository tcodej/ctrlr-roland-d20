...
local TONES = {
    ...
    {"Fantasy","Harmo Pan","Chorale","Glasses","Soundtrack","Atmosphere","Warm Bell","Space Horn","Echo Bell","Ice Rains","Oboe 2002","Echo Pan","Bell Swing","Reso Synth","Steam Pad","VibeString","Syn Lead 1","Syn Lead 2","Syn Lead 3","Syn Lead 4","Syn Bass 1","Syn Bass 2","Syn Bass 3","Syn Bass 4","AcouBass 1","AcouBass 2","ElecBass 1","ElecBass 2","SlapBass 1","SlapBass 2","Fretless 1","Fretless 2","Vibe","Glock","Marimba","Xylophone","Guitar 1","Guitar 2","Elec Gtr 1","Elec Gtr 2","Koto","Shamisen","Jamisen","Sho","Shakuhachi","WadaikoSet","Sitar","Steel Drum","Tech Snare","Elec Tom","Revrse Cym","Ethno Hit","Timpani","Triangle","Wind Bell","Tube Bell","Orche Hit","Bird Tweet","OneNoteJam","Telephone","Typewriter","Insect","WaterBells","JungleTune"},
    -- r
    {"ClsdHiHat1","ClsdHiHat1","OpenHiHat1","OpenHiHat2","Crash Cym","Short CC","Mute CC","Ride Cym","Short RC","Mute RC","Cup","Mute Cup","China Cym","Splash Cym","BassDrum 1","BassDrum 2","BassDrum 3","BassDrum 4","SnareDrum1","SnareDrum2","SnareDrum3","SnareDrum4","SnareDrum5","SnareDrum6","Rim Shot","Brush 1","Brush 2","Hi TomTom1","MidTomTom1","LowTomTom1","Hi TomTom2","MidTomTom2","LowTomTom2","Hi TomTom3","MidTomTom3","LowTomTom3","HiPitchTT1","HiPitchTT2","Hand Clap","Tambourine","Cowbell","Hi Bongo","Lo Bongo","Mt HiConga","Hi Conga","Lo Conga","Hi Timbale","Lo Timbale","Hi Agogo","Lo Agogo","Cabasa","Maracas","ShortWhisl","Long Whisl","Quijada","Claves","Castanets","Triangle","Wood Block","Bell","NativeDrm1","NativeDrm2","NativeDrm3","OFF"}
